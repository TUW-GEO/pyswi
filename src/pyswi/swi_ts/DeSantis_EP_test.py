...
swi_noise_rec, gain_out = calc_swi_noise_rec(ssm, t_value=[5])

results['calc_swi_noise_rec'] = swi_noise_rec['swi_noise_5']

swi_noise, gain_out = calc_swi_noise(ssm, t_value=[5])

results['calc_swi_noise'] = swi_noise['swi_noise_5']

swi_ts_noise, gain_out = calc_swi_ts(ssm, ssm['jd'], t_value=[5])

results['swi_ts_noise'] = swi_ts_noise['swi_noise_5']
