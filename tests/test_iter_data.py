...
class TestIterStepData(unittest.TestCase):
    ...
    def test_metadata_extraction(self):
        path = os.path.join(curpath(), 'data', 'iterative_storage',
    ...
    def test_construct_filename(self):
        ...
        filename = data_coll._construct_file_name(
            datetime(2013, 11, 24, 12), datetime(2013, 11, 24, 12, 2, 58),
            datetime(2013, 11, 25, 17, 47, 33))
    ...
    def test_iter_data_read_write(self):
        ...
        data_coll = IterStepData(self.itersavepath,
                                 100,
                                 variables={
                                     'gain_sigma': -9999.,
                                     'ssf': 255
        ...
        iter_data['header']['processing_end'] = datetime(
            2014, 1, 1, 15, 20, 43)
        iter_data['header']['processing_start'] = datetime(
            2014, 1, 1, 14, 20, 43)
